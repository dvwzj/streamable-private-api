...
var StreamablePrivateAPI = /*#__PURE__*/function () {
  ...
  (0, _createClass2["default"])(StreamablePrivateAPI, [{
                      ...
                      while (1) {
                        switch (_context4.prev = _context4.next) {
                          ...
                          case 3:
                            ...
                            resolve(_lodash["default"].uniqBy(_exists2, function (video) {
    ...
    key: "upload",
    value: function upload(url, title, force, source, extract_id) {
      var _this4 = this;
      ...
      try {
        ...
        if (force === true) {
          ...
          this.exists(source ? source : url).then(function (exists) {
            if (_lodash["default"].size(exists)) {
              _this4.videoUploadEmitter.emit('completed', exists);
            } else {
              _this4.forceUpload(url, title, source, extract_id);
            }
          })["catch"](function (e) {
    ...
    key: "forceUpload",
    value: function forceUpload(url, title, source, extract_id) {
      var _this5 = this;
